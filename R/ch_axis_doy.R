...
#'  
#' This routine deals only with the axis adjustments.  Obtaining the day of water year needs to be done 
#' separately.
#'  
#' @param wyear wyear = 1 for calendar year, wyear = 10 for October 1.
#' 
