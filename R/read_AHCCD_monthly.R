...
#' @author Kevin Shook
#' @seealso  \code{\link{read_AHCCD_daily}} \code{\link{get_AHCCD_monthly}}
#' @references
#' Monthly AHCCD data are available from \url{https://www.canada.ca/en/environment-climate-change/services/climate-change/science-research-data/climate-trends-variability/adjusted-homogenized-canadian-data/surface-air-temperature-access.html}. Any use of 
...
#' @examples
#' \dontrun{
#' Stoon_monthly_precip <- read_AHCCD_monthly("mt4057120.txt")
#' NB_monthly_tmean <- read_AHCCD_monthly("mm4045695.txt") }
#' @import stringr utils
#' @export

read_AHCCD_monthly <- function(monthly_file = NULL) {
  # check parameter
