...
#'
#' @param ... Other parameters for controlling the graphic.
#' 
#' @importFrom stats sd
#'
...
#'
#' PlotMrl(flow~date, CAN01AD002, u = lstu, declust = 'wrc', r = 14)
#'
#' x <- PlotMrl(flow~date, CAN01AD002, u = lstu, declust = 'wrc', r = 14)
#' 
#' head(x)
#'
#' @export
