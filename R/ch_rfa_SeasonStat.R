...
#'
#' @description Returns the circular or seasonal statistics of flood peaks.
#' The angle represents the average timing of the floods and the radius represents its
#' regularity.
#' 
