...
#'@param area.km     Watershed area. The methodology shows a graph for that information; this methodology is for Western US
...
#' PMP(val.max = c(53,103.4,78.2,35.6,50.8,42.2,38.1,35.6,132.9,38.1,20.3,111.8,29,38,76.2,50.8),input.hrs = 24,number.of.obs.unit = 1,area.km = 200,graphs = T)
#'
