...
Indeed, errors must be propagated at each step of the procedure.
...
the gauged sites.
The example below shows that without bootstrap, the uncertainty of the
flood quantiles is under-estimated.
