...
## verify that boot
out0 <- ch_rfa_boot_nspot(fit, rt = c(10,100), nsim = 5, x = flowStJohn, reliability = FALSE)

out0 <- ch_rfa_boot_nspot(fit, rt = c(10,100), x = flowStJohn, nsim = 5,
...
out <- ch_rfa_boot_nspot(fit, rt = c(10,100), x = flowStJohn,
